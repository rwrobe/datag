	...
	class Da_Tag {
		...
		public function admin_notices(){
			...
			if ( ! get_user_meta( $uid, 'thanks_but_no_thanks') ) {
				...
				$notice = __('Hey there <strong>Range</strong>, thanks for taking a look at my highlighted tag plugin! Please let me know if you have any questions: <a href="mailto:RobSWard@gmail.com">RobSWard@gmail.com</a>', $this->localizationDomain);
